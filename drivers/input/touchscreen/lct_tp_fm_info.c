		...
		struct device_attribute *attr, char *buf)
{
    ...
    if((0 == tp_ver_show) && (0 == strlen(tp_ver_show_str)))
        ...
        snprintf(tp_version, 60,"%s V%x\n", module_name, tp_ver_show);  //liyong2 2014.1.4
    else if (0 < strlen(tp_ver_show_str))
        snprintf(tp_version, 60,"%s\n%s\n", module_name, tp_ver_show_str);  //liyong2 2014.1.4
