...
/*
static void plugin_cal_t72_hook_t9(struct plugin_ac *p, int id, int x, int y, u8 status)
{
}
*/
...
/*
static void plugin_cal_t72_hook_t100(struct plugin_ac *p, int id, int x, int y, u8 status)
{
}

static void plugin_cal_t72_reset_slots_hook(struct plugin_ac *p)
{
}
*/
...
struct plugin_ac mxt_plugin_ac_t72 = 
{
	...
	//.hook_t9 = plugin_cal_t72_hook_t9,
	//.hook_t100 = plugin_cal_t72_hook_t100,
	.hook_t61 = plugin_cal_t72_hook_t61,
	//.hook_reset_slots = plugin_cal_t72_reset_slots_hook,
