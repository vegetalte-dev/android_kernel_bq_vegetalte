...
int msm_sensor_check_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if((rc == 0) && (s_ctrl->sensordata->sensor_name != NULL) && ((strcmp(s_ctrl->sensordata->sensor_name,"imx214_8916_cm9886qr") == 0)))
	{
		pr_err("%s:g_imx214_otp_module_id = %x\n", __func__,g_imx214_otp_module_id);
		if((strcmp(s_ctrl->sensordata->sensor_name,"imx214_8916_cm9886qr") == 0) && (g_imx214_otp_module_id == 0x2))
		{
