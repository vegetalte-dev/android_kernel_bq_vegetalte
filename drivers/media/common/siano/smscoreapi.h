...
#define SMS_LARGE_MEM_MALLOC_ONCE	1
...
//platform, such as MTK, ROck chip and so on
#define        SMS_PLATFORM_QUALCOMM
//#define	SMS_PLATFORM_MTK
//#define	SMS_PLATFOMR_RK

extern void sms_chip_plug(int plugin);

#endif

#ifdef SMS_PLATFORM_QUALCOMM
...
#ifdef SMS_PLATFORM_MTK
#include <mach/mt_gpio.h>
#include <cust_gpio_boot.h>

#define  HOST_SMS_RSET_PIN (GPIO20 | 0x80000000)
//#define  HOST_SMS_POWER_IO_PIN (GPIO62 | 0x80000000)
#define  HOST_SMS_POWER_EMI_PIN (GPIO6 | 0x80000000)
#define  HOST_SMS_POWER_CORE_PIN (GPIO3 | 0x80000000)
...
#elif defined(SMS_PLATFOMR_RK)
#define  HOST_SMS_POWER_CORE_PIN RK2928_PIN3_PC0
//#define  HOST_SMS_RSET_PIN
