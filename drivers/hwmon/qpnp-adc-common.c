...
// lct.panguangyi l6140 weike 2000mah ntc parameter
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
    #include "weike_2000mah_ntc_parameter.h"
};
#else
// gdd modify ntc parameter begin
...
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
    #include "lct_battery_ntc_parameter.h"
};
// gdd modify ntc parameter end
#endif
